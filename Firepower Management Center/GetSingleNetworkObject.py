...
api_path = "/api/fmc_config/v1/domain/e276abec-e0f2-11e3-8169-6d9ed49b625f/object/networks/00505686-B660-0ed3-0000-004294968329"    # param
url = server + api_path
if (url[-1] == '/'):
    url = url[:-1]
